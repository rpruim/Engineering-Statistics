...
<<child="Math241-Chap0.Rnw">>=
@

<<child="Math241-Graphical.Rnw">>=
@

<<child="Math241-Numerical.Rnw">>=
@

<<child="Math241-Probability.Rnw", eval = FALSE>>=
@

<<child="Math241-Densities.Rnw", eval = FALSE>>=
@

<<child="Math241-Transformations.Rnw", eval = FALSE>>=
@

<<child="Math241-Propagation.Rnw", eval=FALSE>>=
@

<<child="Math241-SimpleLinear.Rnw", eval=FALSE>>=
@

<<child="Math241-NonLinear.Rnw", eval=FALSE>>=
@

<<child="Math241-HypothesisTesting.Rnw", eval=FALSE>>=
@

<<child="Math241-MoreExamples.Rnw", eval=FALSE>>=
@
