...
\cfoot{}
\lfoot[\sf Last Modified: \today]{\sf Math 241 : Pruim}
\rfoot[\sf Stat 241 : Pruim]{\sf Last Modified: \today}
...
<<child = "Stat241-RandomVariables.Rnw", eval = FALSE>>=
@

<<child = "Stat241-Transformations.Rnw", eval = FALSE>>=
@
