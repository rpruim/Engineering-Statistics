...
a. Waht is the probability of winning a prize?

b. What is the prabability of winning the grand prize?
...
**Example 4.**
	the mean of a symmetric triangle distribution on $[-1, 1]$.
...
<!-- **5.** -->
<!-- Let Do the following by hand, without using R. -->

<!-- 	For what value of C is f a probability density function? -->
<!-- 	If X is the associated random variable, what is E(X)? -->
<!-- 	Find P(X > 2). -->
