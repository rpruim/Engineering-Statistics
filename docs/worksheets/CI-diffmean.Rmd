...
* $\displaystyle \overline{Y_2} \approx \Norm\left(\mu_2, \frac{\sigma_2}{\sqrt{n_2}}\right)$
...
\begin{align*}
  \overline{X_1} - \overline{X_2} & \approx 
    \Norm\left(\mu_2 - \mu_1,  \sqrt{\frac{\sigma^2_1}{n_1} + \frac{\sigma_2^2}{n_2}}\right)
    \\
...
$$
  \frac{(\overline{X_1} - \overline{X_2}) - (\mu_1 - \mu_2)}{
    \sqrt{\frac{s_1^2}{n_1} _ \frac{s_2^2}{n_2}}} \approx \T(df = ?)
$$

* $df$ is given by a complicated formula, but is always satisfies

$$ 
\min(df_1, df_2) \le df \le df_1 + df_2
$$
...
------------------------ ----------------- ----------------------------------- ---------------- ------------------------------------------------------------------
  ...
  difference in means    $\mu_1 - \mu_2$   $\overline{x_1} - \overline{x_2}$        $t_*$          $\displaystyle \sqrt{ \frac{\sigma_1^2}{n_1} + \frac{s_2^2}{n}}$
--------------------------------------------------------------------------------------------------
