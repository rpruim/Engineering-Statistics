...
<<transparency-and-dot-size, fig.width = 5>>=
gf_point(bill_length_mm ~ body_mass_g, color = ~ species, data = penguins,
         size = 0.8, alpha = 0.5)
@
...
<<binwidth,fig.width = 3,out.width = ".3\\textwidth">>=
...
<<density,fig.width = 3,out.width = ".3\\textwidth">>=
...
<<fig.width = 3, out.width = "0.3\\textwidth">>=
...
gf_point(bill_length_mm ~ body_mass_g | island, color = ~ species, data = penguins,
  ...
  gf_labs(x = "body mass (g)", y = "bill length (mm)", 
          title = "Some penguin measurments", caption = "Data Source: palmerpenguins")
@
