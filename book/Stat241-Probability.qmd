...
<!--  We'll also  --> We'll make the simplifying assumption that boys
...
::: {.solution}
$\Prob(\mbox{$X\$ is even and $X < 5$}) = \Prob(X = 2 \torX = 4) =
1/36 + 3/36 = 4/36 = `r 4/36`\$.

$\Prob(\mbox{$X\$ is even or $X < 5$}) = \Prob(\mbox{$X$ is even}) +
\Prob(X = 3) = 18/36 + 2/36 = 20/36 = `r 20/36`\$.
:::
<!-- end solution -->
...
the probability that both function properly is \$0.98 \cdot 0.97 =
`r 0.98 * 0.97` \$.
...
$x = \Prob( C | W \intersectS^c)$. Then
$\Prob( C | W \intersectS ) = 13x$.
...
<!-- begin itemize --> :::: {.itemize} 1. \$G_4 = \$ green from 1994 bag
2. \$G_6 = \$ green from 1996 bag 3. \$Y_4 = \$ yellow from 1994 bag 4.
\$Y_6 = \$ yellow from 1996 bag <!-- end itemize -->
...
![](images/cigarettes-cartoon){fig-align="center"}
