...
S <- X + Y
P <- X * Y
histogram( ~ X , main = "Sample from Unif(0,1)", width = .05, center = 0.025)
histogram( ~ Y , main = "Another sample from Unif(0,1)", width = .05, center = 0.025)
@
<<sum-product-uniform-iid>>=
histogram( ~ S , main = "Sum of two iid Unif(0,1) rvs", width = 0.1, center = 0.05)
histogram( ~ P , main = "Product of two iid Unif(0,1) rvs", width = 0.05, center = 0.025)
@
...
S2 <- X + X
P2 <- X * X 
histogram( ~ S2 , main = "Sum of two non-iid Unif(0,1) rvs", width = 0.1, center = 0.05)
histogram( ~ P2 , main = "Product of two non-iid Unif(0,1) rvs", width = 0.05, center = 0.025)
@
...
Paper <- 
	data.frame(polymer = c(418, 421, 421, 422, 425, 427, 431, 434, 
							37, 439, 446, 447, 448, 453, 454, 463, 465))
@
	\begin{enumerate}
...
gf_density( ~ length, groups = sex, data = KidsFeet)
@
