...
* Worksheets
  ...
  * Confidence Intervals
    ...
    * Sampling Distributions and Confidence intervals 
    [[HTML](worksheets/Sampling-Distributions-and-CIs.html)]
  
    * CIs for differences in means and proportions
    [[HTML](worksheets/CI-diffmean.html)]
  
  * Propagation of Uncertainty [[HTML](worksheets/Propagation-of-Uncertainty.html)]
    
  * Linear Models 
  
    * Intro and Least Squares [[HTML](worksheets/Linear-Models-Intro.html)]
    * How good are the estimates (standard errors and diagnostics)
    [[HTML](worksheets/Linear-Models-Estimates.html)]
    * Linear models and transformations [[HTML](worksheets/Linear-Models-Transformations.html)
    * Non-linear models [[HTML](worksheets/Linear-Models-NLS.html)]
   
  * Hypothesis Testing [[HTML](worksheets/Hypotheis-Testing.html)]
  
  * Review
    * Fundamental of Engineering Review Problems [[HTML](worksheets/FE-Review-problems.html)]