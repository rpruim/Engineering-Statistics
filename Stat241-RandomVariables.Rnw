...
<<>>=
gf_dist("binom", size = 10, prob = 0.5, main = "Binom(10, 0.5)")
gf_dist("binom", size = 10, prob = 0.05, main = "Binom(10, 0.05)")
gf_dist("binom", size = 100, prob = 0.5, main = "Binom(100, 0.5)")
gf_dist("binom", size = 100, prob = 0.05, main = "Binom(100, 0.05)")
@
...
<<>>=
gf_dist("pois", lambda = 1, main = "Pois(1)")
gf_dist("pois", lambda = 5, main = "Pois(5)")
gf_dist("pois", lambda = 15, main = "Pois(15)")
gf_dist("pois", lambda = 50, main = "Pois(50)")
@
...
Wind <- read.file("data/stob/TwinfallsWind.csv")
head(Wind, 2)
tail(Wind, 2)
...
<<hand-qqplot>>=
gf_point( observed ~ theoretical, data = QQData, main = "Hand made QQ-plot" ) %>%
  gf_fun( x ~ x, alpha = 0.6, color = "blue", linetype = "dashed", alpha = 0.6)
@
...
gf_point(observed ~ theoretical, data = QQData2, main = "Hand made QQ-plot", xlab = "theoretical (z)" ) %>%
