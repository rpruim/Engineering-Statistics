...
\cfoot{}
\lfoot[\sf Last Modified: \today]{\sf Math 241 : Spring 2017 : Pruim}
\rfoot[\sf Stat 241 : Spring 2017 : Pruim]{\sf Last Modified: \today}
...
<<child="Stat241-HypothesisTesting.Rnw", eval=TRUE>>=
@

<<child="Stat241-MoreExamples.Rnw", eval=TRUE>>=
@
