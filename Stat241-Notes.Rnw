...
\cfoot{}
\lfoot[\sf Last Modified: \today]{\sf Math 241 : Spring 2016 : Pruim}
\rfoot[\sf Stat 241 : Spring 2016 : Pruim]{\sf Last Modified: \today}
...
\title{Stat 241: Statistics for the Physical Sciences and Engineering}
...
<<child="Stat241-Chap0.Rnw">>=
@

<<child="Stat241-Graphical.Rnw">>=
@

<<child="Stat241-Numerical.Rnw">>=
@

<<child="Stat241-Probability.Rnw", eval = TRUE>>=
@

<<child="Stat241-RandomVariables.Rnw", eval = TRUE>>=
@

<<child="Stat241-Transformations.Rnw", eval = TRUE>>=
@

<<child="Stat241-Propagation.Rnw", eval=FALSE>>=
@

<<child="Stat241-SimpleLinear.Rnw", eval=FALSE>>=
@

<<child="Stat241-NonLinear.Rnw", eval=FALSE>>=
@

<<child="Stat241-HypothesisTesting.Rnw", eval=FALSE>>=
@

<<child="Stat241-MoreExamples.Rnw", eval=FALSE>>=
@
