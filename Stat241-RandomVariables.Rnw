...
\Answer
$E(X) = 0 \cdot 0.2 + 1 \cdot 0.5 + 2 \cdt 0.3 = 0.5 + 0.6 = 1.1$
...
<<>>=
plotDist("binom", size = 10, prob = 0.5, main = "Binom(10, 0.5)")
plotDist("binom", size = 10, prob = 0.05, main = "Binom(10, 0.05)")
plotDist("binom", size = 100, prob = 0.5, main = "Binom(100, 0.5)")
plotDist("binom", size = 100, prob = 0.05, main = "Binom(100, 0.05)")
@
...
<<>>=
plotDist("pois", lambda = 1, main = "Pois(1)")
plotDist("pois", lambda = 5, main = "Pois(5)")
plotDist("pois", lambda = 15, main = "Pois(15)")
plotDist("pois", lambda = 50, main = "Pois(50)")
@
...
then the probability of obtaining exactly Michael's data is 
\[
\left(\frac12\right)^3 \left(\frac12\right)^7 = \Sexpr{.5^3 * .5^7}
\;.
\]
\end{itemize}
